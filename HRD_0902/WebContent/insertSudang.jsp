...
<td><input type="text" name="jikchak" size="20"></td>
</tr>

<tr>
<th style="width: 100px; background-color: #F5F6CE">근속수당</th>
<td colspan="4"><input type="text" name="gunsok" size="30"></td>
</tr>

<tr>
<th style="width: 100px; background-color: #F5F6CE">기타수당</th>
<td colspan="4"><input type="text" name="gitasudang" size="30"></td>
</tr>

<tr>
<td colspan="4" id="btn_i">
<input type="button" value="목록" class="btn_a">
<input type="submit" value="저장" class="btn_a" onclick="javascript:check()">
</td>
</tr>
</table>
</form>
